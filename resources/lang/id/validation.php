...
return [
    ...
    */
    ...
    "are_you_sure_you_want_to_delete_member" => "Apakah kamu yakin ingin menghapus anggota tim ini?",
    "are_you_sure_you_want_to_delete_team" => "Apakah kamu yakin ingin menghapus tim ini?",
    "are_you_sure_you_want_to_leave_team" => "Apakah kamu yakin ingin keluar dari tim ini?",
    ...
    "country" => ":Attribute bukan negara yang valid.",
    "create_team" => "Buat Tim",
    "current_password" => "Kata sandi salah.",
    "current_teams" => "Tim Saat Ini",
    ...
    "edit_team_member" => "Ubah Anggota Tim",
    ...
    "if_you_delete_team_all_data_will_be_deleted" => "Jika Anda memilih untuk menghapus tim, semua data akan dihapus secara permanen.",
    ...
    "leave_team" => "Tinggalkan Tim",
    "looks_like_you_are_not_part_of_team" => "Sepertinya Anda bukan bagian dari tim mana pun!",
    ...
    "not_eligible_based_on_current_members_teams" => "Anda tidak memenuhi syarat untuk paket ini berdasarkan jumlah tim/anggota tim Anda saat ini.",
    ...
    "plan_allows_no_more_teams" => "Paket Anda saat ini tidak mengijinkan Anda membuat lebih banyak tim",
    "please_upgrade_to_add_more_members" => "Tingkatkan paket langganan Anda untuk membuat lebih banyak anggota tim.",
    "please_upgrade_to_create_more_teams" => "Tingkatkan paket langganan Anda untuk membuat lebih banyak tim.",
    ...
    "remove_team_member" => "Hapus Anggota Tim",
    ...
    "required_with" => ":Attribute tidak sesuai dengan :values.",
    ...
    "slug_input_explanation" => "Slug ini digunakan untuk mengidentifikasi tim Anda di URL.",
    "starts_with" => ":Attribute harus diawali salah satu dari berikut: :values",
    "state" => "Negara bagian ini tidak valid untuk negara yang ditentukan.",
    "string" => ":Attribute harus berupa string.",
    "team" => "Tim",
    "team_billing" => "Tagihan Tim",
    "team_members" => "Anggota Tim",
    "team_name" => "Nama Tim",
    "team_name_was_updated" => "Nama tim Anda telah diperbarui!",
    "team_photo" => "Foto Tim",
    "team_profile" => "Profil Tim",
    "team_settings" => "Pengaturan Tim",
    "team_slug" => "Slug Tim",
    "team_trial" => "Uji Coba Tim",
    "team_trial_will_expire_on" => "Masa percobaan tim akan berakhir pada :date.",
    "teams" => "Tim",
    "teams_currently_trialing" => "Tim Sedang Uji Coba",
    ...
    "update_team_name" => "Perbarui Nama Tim",
    ...
    "user_already_invited_to_team" => "Pengguna tersebut sudah diundang ke tim.",
    "user_already_on_team" => "Pengguna tersebut sudah ada di tim.",
    "user_doesnt_belong_to_team" => "Pengguna bukan anggota dari tim yang diberikan.",
    "user_invited_to_join_team" => ":UserName telah mengundang Anda untuk bergabung dengan tim!",
    "uuid" => ":Attribute harus merupakan UUID yang valid.",
    "vat_id" => "Nomor identifikasi VAT/PPN ini tidak valid.",
    "view_all_teams" => "Lihat Semua Tim",
    "we_found_invitation_to_team" => "Kami menemukan undangan Anda ke tim :teamName!",
    "wheres_your_team" => "Mana Tim Anda?",
    "you_have_been_invited_to_join_team" => "Anda telah diundang untuk bergabung dengan tim :teamName!",
    "you_have_x_invitations_remaining" => "Saat ini Anda memiliki :count undangan tersisa.",
    "you_have_x_teams_remaining" => "Saat ini Anda memiliki :teamCount tim tersisa."
